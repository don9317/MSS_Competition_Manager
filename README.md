# MSS League Scheduler v11.11.76

## v11.11.76 — retain partial schedules and audit unmet guarantees
...
## v11.11.76 — responsive guaranteed-game placement
...
## v11.11.76 — Court Group assignment consistency
...
## v11.11.76 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.76 application.
For local use, open **START_HERE.html**.

## v11.11.76 — Corrected Diagnostic Build
...
## v11.11.76 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.76.
...
## v11.11.76 — Schedule Restore / Upgrade Safety
...
## v11.11.76 — Chronological Immediate Rematch Fix
...
## v11.11.76 — Audit Detail Expansion
...
## v11.11.76 — Safe Court-Only Utilization
...
## v11.11.76 — Corrected Separate Court + Time Optimizer
- Visible green **Optimize Court + Time Use** button on the Schedule page.
- Visible **BUILD CHECK: v11.11.76** banner confirms the correct `index.html` is live.
...
## v11.11.76 — Block Court + Time Utilization
...
## v11.11.76 — Instrumented Single-Date Court + Time Optimization
...
## v11.11.76 — Diagnostic Optimization Status
...
## v11.11.76 — Global Optimization Stage Fix
...
## v11.11.76 — Production Readiness
...
## v11.11.76 — Opponent Rotation Regression Fix
...
## v11.11.76 — Chronological Opponent Coverage
...
## v11.11.76 — Odd-Pool Sequence Repair
...
## v11.11.76 — Production Re-Optimize Hotfix
...
## v11.11.76 — Production Performance & Browser-Safety Fix
...
## v11.11.76 — Deterministic Odd-Pool Repair + Direct Audit Confirmation
...
## v11.11.76 SAFE — v67 Baseline + Hard Regression Gate
...
## v11.11.76 — Surgical Opponent Repair
