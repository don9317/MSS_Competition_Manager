# MSS League Scheduler v11.11.73

## v11.11.73 — retain partial schedules and audit unmet guarantees
...
## v11.11.73 — responsive guaranteed-game placement
...
## v11.11.73 — Court Group assignment consistency
...
## v11.11.73 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.73 application.
For local use, open **START_HERE.html**.

## v11.11.73 — Corrected Diagnostic Build
...
## v11.11.73 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.73.
...
## v11.11.73 — Schedule Restore / Upgrade Safety
...
## v11.11.73 — Chronological Immediate Rematch Fix
...
## v11.11.73 — Audit Detail Expansion
...
## v11.11.73 — Safe Court-Only Utilization
...
## v11.11.73 — Corrected Separate Court + Time Optimizer
- Visible green **Optimize Court + Time Use** button on the Schedule page.
- Visible **BUILD CHECK: v11.11.73** banner confirms the correct `index.html` is live.
...
## v11.11.73 — Block Court + Time Utilization
...
## v11.11.73 — Instrumented Single-Date Court + Time Optimization
...
## v11.11.73 — Diagnostic Optimization Status
...
## v11.11.73 — Global Optimization Stage Fix
...
## v11.11.73 — Production Readiness
...
## v11.11.73 — Opponent Rotation Regression Fix
...
## v11.11.73 — Chronological Opponent Coverage
...
## v11.11.73 — Odd-Pool Sequence Repair
...
## v11.11.73 — Production Re-Optimize Hotfix
...
## v11.11.73 — Production Performance & Browser-Safety Fix
...
## v11.11.73 — Deterministic Odd-Pool Repair + Direct Audit Confirmation
...
## v11.11.73 SAFE — v67 Baseline + Hard Regression Gate
...
## v11.11.73 — Surgical Opponent Repair
