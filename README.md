# MSS League Scheduler v11.11.54

## v11.11.54 — retain partial schedules and audit unmet guarantees
...
## v11.11.54 — responsive guaranteed-game placement
...
## v11.11.54 — Court Group assignment consistency
...
## v11.11.54 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.54 application.
For local use, open **START_HERE.html**.

## v11.11.54 — Corrected Diagnostic Build
...
## v11.11.54 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.54.
...
## v11.11.54 — Schedule Restore / Upgrade Safety
...
## v11.11.54 — Chronological Immediate Rematch Fix
...
## v11.11.54 — Audit Detail Expansion
...
## v11.11.54 — Safe Court-Only Utilization
...
## v11.11.54 — Corrected Separate Court + Time Optimizer
- Visible green **Optimize Court + Time Use** button on the Schedule page.
- Visible **BUILD CHECK: v11.11.54** banner confirms the correct `index.html` is live.
...
## v11.11.54 — Block Court + Time Utilization
