# MSS League Scheduler v11.11.61

## v11.11.61 — retain partial schedules and audit unmet guarantees
...
## v11.11.61 — responsive guaranteed-game placement
...
## v11.11.61 — Court Group assignment consistency
...
## v11.11.61 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.61 application.
For local use, open **START_HERE.html**.

## v11.11.61 — Corrected Diagnostic Build
...
## v11.11.61 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.61.
...
## v11.11.61 — Schedule Restore / Upgrade Safety
...
## v11.11.61 — Chronological Immediate Rematch Fix
...
## v11.11.61 — Audit Detail Expansion
...
## v11.11.61 — Safe Court-Only Utilization
...
## v11.11.61 — Corrected Separate Court + Time Optimizer
- Visible green **Optimize Court + Time Use** button on the Schedule page.
- Visible **BUILD CHECK: v11.11.61** banner confirms the correct `index.html` is live.
...
## v11.11.61 — Block Court + Time Utilization
...
## v11.11.61 — Instrumented Single-Date Court + Time Optimization
...
## v11.11.61 — Diagnostic Optimization Status
...
## v11.11.61 — Global Optimization Stage Fix
...
## v11.11.61 — Production Readiness
...
## v11.11.61 — Opponent Rotation Regression Fix
...
## v11.11.61 — Chronological Opponent Coverage
