# MSS League Scheduler v11.11.53

## v11.11.53 — retain partial schedules and audit unmet guarantees
...
## v11.11.53 — responsive guaranteed-game placement
...
## v11.11.53 — Court Group assignment consistency
...
## v11.11.53 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.53 application.
For local use, open **START_HERE.html**.

## v11.11.53 — Corrected Diagnostic Build
...
## v11.11.53 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.53.
...
## v11.11.53 — Schedule Restore / Upgrade Safety
...
## v11.11.53 — Chronological Immediate Rematch Fix
...
## v11.11.53 — Audit Detail Expansion
...
## v11.11.53 — Safe Court-Only Utilization
...
## v11.11.53 — Corrected Separate Court + Time Optimizer
- Visible green **Optimize Court + Time Use** button on the Schedule page.
- Visible **BUILD CHECK: v11.11.53** banner confirms the correct `index.html` is live.
