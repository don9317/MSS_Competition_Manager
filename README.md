# MSS League Scheduler v11.11.66

## v11.11.66 — retain partial schedules and audit unmet guarantees
...
## v11.11.66 — responsive guaranteed-game placement
...
## v11.11.66 — Court Group assignment consistency
...
## v11.11.66 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.66 application.
For local use, open **START_HERE.html**.

## v11.11.66 — Corrected Diagnostic Build
...
## v11.11.66 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.66.
...
## v11.11.66 — Schedule Restore / Upgrade Safety
...
## v11.11.66 — Chronological Immediate Rematch Fix
...
## v11.11.66 — Audit Detail Expansion
...
## v11.11.66 — Safe Court-Only Utilization
...
## v11.11.66 — Corrected Separate Court + Time Optimizer
- Visible green **Optimize Court + Time Use** button on the Schedule page.
- Visible **BUILD CHECK: v11.11.66** banner confirms the correct `index.html` is live.
...
## v11.11.66 — Block Court + Time Utilization
...
## v11.11.66 — Instrumented Single-Date Court + Time Optimization
...
## v11.11.66 — Diagnostic Optimization Status
...
## v11.11.66 — Global Optimization Stage Fix
...
## v11.11.66 — Production Readiness
...
## v11.11.66 — Opponent Rotation Regression Fix
...
## v11.11.66 — Chronological Opponent Coverage
...
## v11.11.66 — Odd-Pool Sequence Repair
...
## v11.11.66 — Production Re-Optimize Hotfix
...
## v11.11.66 — Production Performance & Browser-Safety Fix
...
## v11.11.66 — Pool-Level Opponent Solver + Audit Confirmation

Built from v11.11.64, deliberately excluding the slow v65 finisher.

Pool-level solver:
- targets only pools currently failing Immediate Rematches or All Opponents Before Repeats;
- keeps the existing game slots (date/time/court) and each team's game-count target;
- evaluates complete pool matchup assignments instead of requiring every intermediate two-game swap to improve;
- accepts a rebuilt pool only if league-wide opponent sequencing improves and no protected hard Audit rule worsens;
- skips pools containing locked manual/director games;
- bounded to roughly 4.5 seconds per pool, 12 seconds total, and 180 attempts per pool;
- yields to the browser during search.

Audit UX:
- Audit Entire League and Audit Selected Scope now show AUDIT COMPLETE;
- completion timestamp, measured runtime, failed hard-rule count, and warning count are displayed;
- the Audit buttons show Auditing... while running.
