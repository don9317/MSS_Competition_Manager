# MSS League Scheduler v11.11.65

## v11.11.65 — retain partial schedules and audit unmet guarantees
...
## v11.11.65 — responsive guaranteed-game placement
...
## v11.11.65 — Court Group assignment consistency
...
## v11.11.65 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.65 application.
For local use, open **START_HERE.html**.

## v11.11.65 — Corrected Diagnostic Build
...
## v11.11.65 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.65.
...
## v11.11.65 — Schedule Restore / Upgrade Safety
...
## v11.11.65 — Chronological Immediate Rematch Fix
...
## v11.11.65 — Audit Detail Expansion
...
## v11.11.65 — Safe Court-Only Utilization
...
## v11.11.65 — Corrected Separate Court + Time Optimizer
- Visible green **Optimize Court + Time Use** button on the Schedule page.
- Visible **BUILD CHECK: v11.11.65** banner confirms the correct `index.html` is live.
...
## v11.11.65 — Block Court + Time Utilization
...
## v11.11.65 — Instrumented Single-Date Court + Time Optimization
...
## v11.11.65 — Diagnostic Optimization Status
...
## v11.11.65 — Global Optimization Stage Fix
...
## v11.11.65 — Production Readiness
...
## v11.11.65 — Opponent Rotation Regression Fix
...
## v11.11.65 — Chronological Opponent Coverage
...
## v11.11.65 — Odd-Pool Sequence Repair
...
## v11.11.65 — Production Re-Optimize Hotfix
...
## v11.11.65 — Production Performance & Browser-Safety Fix
...
## v11.11.65 — Surgical Odd-Pool Opponent Finisher

Built on the responsive/bounded v64 production baseline.

The final opponent pass:
- examines only pools that still show Immediate Rematch or All Opponents Before Repeats issues;
- operates only on odd-sized pools;
- changes opponent identities only;
- never changes game date, time, court, or game count;
- never changes a locked manual/director game;
- accepts a candidate only when the affected pool improves, the league-wide opponent score
  improves, and no protected hard Audit rule worsens;
- is bounded to 120 total candidate checks, 48 per pool, and roughly 12 seconds;
- yields to the browser while working.

The existing v64 core optimizer and performance safeguards remain in place.
