# MSS League Scheduler v11.11.60

## v11.11.60 — retain partial schedules and audit unmet guarantees
...
## v11.11.60 — responsive guaranteed-game placement
...
## v11.11.60 — Court Group assignment consistency
...
## v11.11.60 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.60 application.
For local use, open **START_HERE.html**.

## v11.11.60 — Corrected Diagnostic Build
...
## v11.11.60 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.60.
...
## v11.11.60 — Schedule Restore / Upgrade Safety
...
## v11.11.60 — Chronological Immediate Rematch Fix
...
## v11.11.60 — Audit Detail Expansion
...
## v11.11.60 — Safe Court-Only Utilization
...
## v11.11.60 — Corrected Separate Court + Time Optimizer
- Visible green **Optimize Court + Time Use** button on the Schedule page.
- Visible **BUILD CHECK: v11.11.60** banner confirms the correct `index.html` is live.
...
## v11.11.60 — Block Court + Time Utilization
...
## v11.11.60 — Instrumented Single-Date Court + Time Optimization
...
## v11.11.60 — Diagnostic Optimization Status
...
## v11.11.60 — Global Optimization Stage Fix
...
## v11.11.60 — Production Readiness
...
## v11.11.60 — Opponent Rotation Regression Fix
