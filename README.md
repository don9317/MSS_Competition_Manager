# MSS League Scheduler v11.11.48

## v11.11.48 — retain partial schedules and audit unmet guarantees
...
## v11.11.48 — responsive guaranteed-game placement
...
## v11.11.48 — Court Group assignment consistency
...
## v11.11.48 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.48 application.
For local use, open **START_HERE.html**.

## v11.11.48 — Corrected Diagnostic Build
...
## v11.11.48 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.48.
...
## v11.11.48 — Schedule Restore / Upgrade Safety
...
## v11.11.48 — Chronological Immediate Rematch Fix
...
## v11.11.48 — Audit Detail Expansion
