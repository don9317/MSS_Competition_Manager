# MSS League Scheduler v11.11.62

## v11.11.62 — retain partial schedules and audit unmet guarantees
...
## v11.11.62 — responsive guaranteed-game placement
...
## v11.11.62 — Court Group assignment consistency
...
## v11.11.62 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.62 application.
For local use, open **START_HERE.html**.

## v11.11.62 — Corrected Diagnostic Build
...
## v11.11.62 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.62.
...
## v11.11.62 — Schedule Restore / Upgrade Safety
...
## v11.11.62 — Chronological Immediate Rematch Fix
...
## v11.11.62 — Audit Detail Expansion
...
## v11.11.62 — Safe Court-Only Utilization
...
## v11.11.62 — Corrected Separate Court + Time Optimizer
- Visible green **Optimize Court + Time Use** button on the Schedule page.
- Visible **BUILD CHECK: v11.11.62** banner confirms the correct `index.html` is live.
...
## v11.11.62 — Block Court + Time Utilization
...
## v11.11.62 — Instrumented Single-Date Court + Time Optimization
...
## v11.11.62 — Diagnostic Optimization Status
...
## v11.11.62 — Global Optimization Stage Fix
...
## v11.11.62 — Production Readiness
...
## v11.11.62 — Opponent Rotation Regression Fix
...
## v11.11.62 — Chronological Opponent Coverage
...
## v11.11.62 — Odd-Pool Sequence Repair
