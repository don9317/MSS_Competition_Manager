# MSS League Scheduler v11.11.64

## v11.11.64 — retain partial schedules and audit unmet guarantees
...
## v11.11.64 — responsive guaranteed-game placement
...
## v11.11.64 — Court Group assignment consistency
...
## v11.11.64 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.64 application.
For local use, open **START_HERE.html**.

## v11.11.64 — Corrected Diagnostic Build
...
## v11.11.64 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.64.
...
## v11.11.64 — Schedule Restore / Upgrade Safety
...
## v11.11.64 — Chronological Immediate Rematch Fix
...
## v11.11.64 — Audit Detail Expansion
...
## v11.11.64 — Safe Court-Only Utilization
...
## v11.11.64 — Corrected Separate Court + Time Optimizer
- Visible green **Optimize Court + Time Use** button on the Schedule page.
- Visible **BUILD CHECK: v11.11.64** banner confirms the correct `index.html` is live.
...
## v11.11.64 — Block Court + Time Utilization
...
## v11.11.64 — Instrumented Single-Date Court + Time Optimization
...
## v11.11.64 — Diagnostic Optimization Status
...
## v11.11.64 — Global Optimization Stage Fix
...
## v11.11.64 — Production Readiness
...
## v11.11.64 — Opponent Rotation Regression Fix
...
## v11.11.64 — Chronological Opponent Coverage
...
## v11.11.64 — Odd-Pool Sequence Repair
...
## v11.11.64 — Production Re-Optimize Hotfix
...
## v11.11.64 — Production Performance & Browser-Safety Fix
