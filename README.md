# MSS League Scheduler v11.11.47

## v11.11.47 — retain partial schedules and audit unmet guarantees
...
## v11.11.47 — responsive guaranteed-game placement
...
## v11.11.47 — Court Group assignment consistency
...
## v11.11.47 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.47 application.
For local use, open **START_HERE.html**.

## v11.11.47 — Corrected Diagnostic Build
...
## v11.11.47 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.47.
...
## v11.11.47 — Schedule Restore / Upgrade Safety
...
## v11.11.47 — Chronological Immediate Rematch Fix
