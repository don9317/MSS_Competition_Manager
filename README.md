# MSS League Scheduler v11.11.75

## v11.11.75 — retain partial schedules and audit unmet guarantees
...
## v11.11.75 — responsive guaranteed-game placement
...
## v11.11.75 — Court Group assignment consistency
...
## v11.11.75 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.75 application.
For local use, open **START_HERE.html**.

## v11.11.75 — Corrected Diagnostic Build
...
## v11.11.75 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.75.
...
## v11.11.75 — Schedule Restore / Upgrade Safety
...
## v11.11.75 — Chronological Immediate Rematch Fix
...
## v11.11.75 — Audit Detail Expansion
...
## v11.11.75 — Safe Court-Only Utilization
...
## v11.11.75 — Corrected Separate Court + Time Optimizer
- Visible green **Optimize Court + Time Use** button on the Schedule page.
- Visible **BUILD CHECK: v11.11.75** banner confirms the correct `index.html` is live.
...
## v11.11.75 — Block Court + Time Utilization
...
## v11.11.75 — Instrumented Single-Date Court + Time Optimization
...
## v11.11.75 — Diagnostic Optimization Status
...
## v11.11.75 — Global Optimization Stage Fix
...
## v11.11.75 — Production Readiness
...
## v11.11.75 — Opponent Rotation Regression Fix
...
## v11.11.75 — Chronological Opponent Coverage
...
## v11.11.75 — Odd-Pool Sequence Repair
...
## v11.11.75 — Production Re-Optimize Hotfix
...
## v11.11.75 — Production Performance & Browser-Safety Fix
...
## v11.11.75 — Deterministic Odd-Pool Repair + Direct Audit Confirmation
...
## v11.11.75 SAFE — v67 Baseline + Hard Regression Gate
...
## v11.11.75 — Surgical Opponent Repair
