# MSS League Scheduler v11.11.63

## v11.11.63 — retain partial schedules and audit unmet guarantees
...
## v11.11.63 — responsive guaranteed-game placement
...
## v11.11.63 — Court Group assignment consistency
...
## v11.11.63 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.63 application.
For local use, open **START_HERE.html**.

## v11.11.63 — Corrected Diagnostic Build
...
## v11.11.63 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.63.
...
## v11.11.63 — Schedule Restore / Upgrade Safety
...
## v11.11.63 — Chronological Immediate Rematch Fix
...
## v11.11.63 — Audit Detail Expansion
...
## v11.11.63 — Safe Court-Only Utilization
...
## v11.11.63 — Corrected Separate Court + Time Optimizer
- Visible green **Optimize Court + Time Use** button on the Schedule page.
- Visible **BUILD CHECK: v11.11.63** banner confirms the correct `index.html` is live.
...
## v11.11.63 — Block Court + Time Utilization
...
## v11.11.63 — Instrumented Single-Date Court + Time Optimization
...
## v11.11.63 — Diagnostic Optimization Status
...
## v11.11.63 — Global Optimization Stage Fix
...
## v11.11.63 — Production Readiness
...
## v11.11.63 — Opponent Rotation Regression Fix
...
## v11.11.63 — Chronological Opponent Coverage
...
## v11.11.63 — Odd-Pool Sequence Repair
...
## v11.11.63 — Production Re-Optimize Hotfix
