# MSS League Scheduler v11.11.49

## v11.11.49 — retain partial schedules and audit unmet guarantees
...
## v11.11.49 — responsive guaranteed-game placement
...
## v11.11.49 — Court Group assignment consistency
...
## v11.11.49 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.49 application.
For local use, open **START_HERE.html**.

## v11.11.49 — Corrected Diagnostic Build
...
## v11.11.49 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.49.
...
## v11.11.49 — Schedule Restore / Upgrade Safety
...
## v11.11.49 — Chronological Immediate Rematch Fix
...
## v11.11.49 — Audit Detail Expansion
...
## v11.11.49 — Scheduling Model Lockdown
