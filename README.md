# MSS League Scheduler v11.11.55

## v11.11.55 — retain partial schedules and audit unmet guarantees
...
## v11.11.55 — responsive guaranteed-game placement
...
## v11.11.55 — Court Group assignment consistency
...
## v11.11.55 guarantee-first scheduling
...
GitHub Pages will launch **index.html**, which is this v11.11.55 application.
For local use, open **START_HERE.html**.

## v11.11.55 — Corrected Diagnostic Build
...
## v11.11.55 — Stable Scheduler + Separate Diagnostic
- `index.html` is the known-working v11.11.42 scheduler code with only the visible version updated to v11.11.55.
...
## v11.11.55 — Schedule Restore / Upgrade Safety
...
## v11.11.55 — Chronological Immediate Rematch Fix
...
## v11.11.55 — Audit Detail Expansion
...
## v11.11.55 — Safe Court-Only Utilization
...
## v11.11.55 — Corrected Separate Court + Time Optimizer
- Visible green **Optimize Court + Time Use** button on the Schedule page.
- Visible **BUILD CHECK: v11.11.55** banner confirms the correct `index.html` is live.
...
## v11.11.55 — Block Court + Time Utilization
...
## v11.11.55 — Instrumented Single-Date Court + Time Optimization
